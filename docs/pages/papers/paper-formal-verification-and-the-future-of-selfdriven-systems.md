---
layout: selfdriven
title: Formal Verification and the Future of selfdriven Systems - selfdriven Institute
permalink: /paper/formal-verification-and-the-future-of-selfdriven-systems
description: "From Code That Seems to Work to Code That Cannot Fail"
---
...
1. Humans describe desired behaviour in natural language
2. Developers write code
3. Tests are written
4. Bugs are found
5. Patches are applied
6. More bugs emerge later
...
1. the specification,
2. the proof checker,
3. and the underlying mathematics.
...
For example:
1. An advanced AI discovers a superior coordination algorithm
2. The AI rewrites it into a verifiable language like Lean
3. The AI generates a proof of correctness
4. Humans verify the proof
5. The system is deployed with mathematical guarantees
...
In the verification era:
language itself becomes executable mathematics.
...
<audio controls>
	<source src="/assets/audio/selfdriven-institute-signal-shot-ends-vibe-coding.m4a" type="audio/mp4">
